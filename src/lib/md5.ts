/*
 * Compact MD5 implementation (based on the public-domain / MIT blueimp-md5).
 * Subsonic authentication requires token = md5(password + salt); the browser's
 * Web Crypto API does not offer MD5, so we implement it here.
 */
